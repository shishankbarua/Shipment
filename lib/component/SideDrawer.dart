...
class SideaBar extends StatefulWidget {
  const SideaBar({ Key? key }) : super(key: key);

  @override
  _SideaBarState createState() => _SideaBarState();
}

class _SideaBarState extends State<SideaBar> {
    bool _value = false;
  List image = [];
  int? val = -1;
  var h, w;
